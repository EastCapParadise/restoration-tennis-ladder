...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    if (document.getElementById("home-leaderboards")) await loadHomeLeaderboards();
...
/* =========================
   HOME LEADERBOARDS DATA
========================= */

async function loadHomeLeaderboards() {
  if (!document.getElementById("home-leaderboards")) return;
  ...
  try {
    ...
    console.error("Home leaderboards error:", err);
  }
}
 ...
 *   Fav 0.5 wins,      6-3 6-2   → winner=11, loser=9
